                    ...
                    <div class="widget-content nopadding">
                        <form class="form-horizontal">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" id="title" name="title" maxlength="64" value="<?php echo ($list['title']); ?>" />
                                    <input type="hidden" id="actid" value="<?php echo ($list['id']); ?>" />
                                </div>
                            </div>
                            <div class="control-group">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" id="keyword" name="keyword" maxlength="256" value="<?php echo ($list['keyword']); ?>" placeholder="关键词之间用英文符 , 隔开" />
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">SEO描述</label>
                                <div class="controls">
                                    <input type="text" id="description" name="description" maxlength="256" value="<?php echo ($list['description']); ?>" />
                                </div>
                            </div>
                            <div class="control-group">
        ...
        $(document).ready(function(){
            $('form .sure').click(function(){
                ...
                if(_title.trim == ''){
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo U('Content/altContent');?>",
