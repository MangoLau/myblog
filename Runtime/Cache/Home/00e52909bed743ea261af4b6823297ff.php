...
<head>
    ...
    <link rel="stylesheet" href="/myblog/Public/Index/css/style.css" />
...
<div id="wrap">
    ...
    <div id="left">
        <ul>
            <?php if(is_array($newest)): $i = 0; $__LIST__ = $newest;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li>
                    <a href="<?php echo U('Content/baseList',array('id'=>$v['id']));?>" title="<?php echo ($v['title']); ?>"><?php echo ($v['title']); ?><span><?php echo ($v['created']); ?></span></a>
                    <div>
                        <?php echo cuthtml(html_entity_decode($v['content']), 300);;?>
                    </div>
